...
export default defineThemeConfig({
 ...
 social: [
    { icon: 'github', link: 'https://github.com/El-12stu' },
    {
      ...
      link: 'https://blog.csdn.net/weixin_73727639?spm=1000.2115.3001.5343'
    },
      ],
  ...
  profile: {
    avatar: '/blogger.jpg',
    name: '阿依木拉提',
    description: 'Share my journey of learning and growth',
    circle: true,
    location: 'Chengdu, China',
    organization: 'UESTC|SE',
  },
